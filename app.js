...
document.write("<h1>Q2,3,4,5,7,8,9,12 in alert box</h1>");
...
document.write(
  userInput + "<br>Occurrences of any two vowels in succession:",
  occurrences
);
...
var distanceKm = parseFloat(
  prompt("Enter distance between two cities (in km):")
);
...
// Define calculateNotes function to calculate the number of notes
function calculateNotes(amount) {
  // Your logic to calculate the number of notes goes here
  // Return an object with the count of each note denomination
  return {
    100: Math.floor(amount / 100), // Assuming 100 is one of the note denominations
    50: Math.floor((amount % 100) / 50), // Assuming 50 is another note denomination
    10: Math.floor(((amount % 100) % 50) / 10), // Assuming 10 is another note denomination
...
var notes = calculateNotes(amount);
document.write(
  You will have ${notes[100]} hundred notes, ${notes[50]} fifty notes, and ${notes[10]} ten notes.
);
...
document.write(
  "Date with the day of the week changed: " + resultDate.toDateString()
);
